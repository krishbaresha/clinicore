...
export default function StockLedgerModal({ isOpen, onClose, initialItem = null }) {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[999] flex items-center justify-center p-2 sm:p-4 overflow-y-auto animate-in fade-in">
      <div className="glass-modal w-full max-w-6xl rounded-3xl shadow-2xl border border-slate-200/80 flex flex-col max-h-[92vh] overflow-hidden my-auto">
            ...
            <div className="flex-1 flex flex-col min-h-[240px] max-h-[280px] p-3.5">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-xs font-black uppercase text-slate-800 tracking-wider flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-sm text-teal-700">category</span>
            ...
            <div className="flex-1 flex flex-col min-h-[260px] p-3.5">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-xs font-black uppercase text-teal-900 tracking-wider flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-sm text-teal-700">inventory_2</span>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pb-3 border-b border-slate-100">
              <div>
                <h3 className="text-sm font-black uppercase text-teal-900 tracking-wider flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-base text-teal-700">receipt_long</span>
                  ...
                  {timeline.length > 0 ? (
                      ...
                      >
                        ...
                        <td className="py-2.5 px-4 text-right">
                          <button
                            ...
                            className="min-h-[34px] px-3 py-1 rounded-xl bg-slate-100 group-hover:bg-teal-700 group-hover:text-white text-slate-700 text-[11px] font-bold inline-flex items-center gap-1 transition-all cursor-pointer shadow-2xs"
                          >
                    ...
                    <tr>
                      <td colSpan={4} className="py-16 text-center text-slate-400 font-semibold">
                        <span className="material-symbols-outlined text-4xl block mb-1 text-slate-300">history_toggle_off</span>
      ...
      {showDateHistoryModal && selectedDateRow && (
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-[1000] flex items-center justify-center p-3 sm:p-6 animate-in fade-in">
          <div className="glass-modal w-full max-w-4xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[85vh]">
