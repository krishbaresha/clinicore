...
export default function DeveloperAdminPanel() {
  ...
  const handleTestResendEmail = async () => {
    ...
    showToast("📨 Generating encrypted .cfbak and dispatching email via Resend API...");
        ...
        html: `
          <div style="font-family: Arial, sans-serif; padding: 24px; background: #f8fafc; border-radius: 16px; border: 1px solid #ccfbf1; max-width: 600px; color: #0f172a;">
            ...
            <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 16px; margin: 16px 0;">
              <h4 style="margin: 0 0 10px 0; color: #334155; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">Audit Executive Snapshot:</h4>
              <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #475569;">
                <li><strong>Report Date:</strong> ${new Date().toLocaleString("en-PK")}</li>
                <li><strong>Total Inflows:</strong> Rs. ${auditMetrics.totalInflows.toLocaleString()}</li>
                <li><strong>Godown Stock Valuation:</strong> Rs. ${auditMetrics.totalStockValuation.toLocaleString()}</li>
                <li><strong>Active Doctors & Staff:</strong> ${usersList.length}</li>
              </ul>
            </div>
    ...
    <div className="min-h-screen bg-[#f8faf9] text-slate-800 font-sans selection:bg-teal-600 selection:text-white flex flex-col">
      ...
      <div className="flex flex-1 relative min-w-0">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-6 pb-24 md:pb-12">
          ...
          {/* ================================================================= */}
          {activeTab === "apis" && (
            <form onSubmit={handleSaveClinicSettings} className="bg-white border border-teal-100 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm animate-fade-in max-w-3xl mx-auto">
              <div className="border-b border-teal-50 pb-4">
                <h3 className="text-lg font-black text-teal-950 flex items-center gap-2">
                  <span className="material-symbols-outlined text-teal-700">api</span>
                  Automated Background Services &amp; Resend Email API
                </h3>
                <p className="text-xs text-slate-500 mt-0.5 font-medium">
                  Configure Resend email credentials for scheduled daily closing and 6-month executive audit dispatches
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 mt-1 font-medium">
                    Get your API key at <strong>resend.com</strong>. Kept secure and hidden from doctor/receptionist portals.
                  </p>
                </div>
              ...
              <div className="pt-4 border-t border-teal-50 flex items-center justify-between">
                <button
                  ...
                  className="bg-teal-50 hover:bg-teal-100 text-teal-900 font-bold text-xs px-5 py-3 rounded-2xl border border-teal-200 transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                  <span className="material-symbols-outlined text-base text-teal-700">send</span>
                  Test Email Dispatch
                </button>
