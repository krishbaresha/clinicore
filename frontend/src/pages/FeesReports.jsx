...
import { openWhatsAppSmart, formatWhatsAppPhone } from "../utils/whatsappPdfHelper.js";
...
export default function FeesReports() {
  ...
  const handleSendWhatsApp = () => {
    ...
    if (navigator.clipboard && navigator.clipboard.writeText) {
      try { navigator.clipboard.writeText(waText); } catch {}
    }

    openWhatsAppSmart(cleanPhone, waText);
  };
